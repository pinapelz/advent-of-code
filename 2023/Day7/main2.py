...
with open("input.txt", "r") as f:
    ...
    for line in lines:
        ...
        for card in cards:
            current_hand[card] += 1
        j_count = current_hand.pop('J', 0)  # Get 'J' count and remove 'J' from current_hand
        for card in current_hand.keys():
            current_hand[card] += j_count  # Add 'J' count to all other cards
